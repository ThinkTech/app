...
<div class="window details">
	...
	<fieldset>
		...
		<div class="info-tasks">
		  ...
		  <a class="task-list-chart"><i class="fa fa-bar-chart" aria-hidden="true"></i></a>
		  </h1>
  ...
  <section>
   <span>Merci pour votre souscription au {plan}</span>
	...
	<div class="col-md-12">
	   ...
	   <hr/>
	   <p>Le contrat vous liant à ThinkTech a été généré et votre projet a été transmis à notre staff technique pour traitement. La durée du projet est estimée à 3 mois et vous pouvez bien entendu suivre son évolution. Nous vous contacterons sous peu pour de 
