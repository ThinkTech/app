...
<div class="window details" data-url="${path}/${url}">
	...
	<fieldset>
		...
		<span data-status="stand by" style="display:none"><span class="label label-info">en attente</span> <span class="label label-info">paiement</span>
